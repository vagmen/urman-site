export const feedbackVideo = [
    {
        ...
        header:
            '"ООО "Гринландия" зарекомендовало себя как порядочная добросовестная организация с качественным выполнением работ"',
...
export const feedback = [
    ...
    },
    {
        ...
        img: "../images/feedback/13.png",
        alt: 'Отзыв от компании "Лесная поляна"',
    },
    {
        id: 14,
    ...
    },
    {
        ...
        img: "../images/feedback/15.png",
        alt: 'Отзыв от компании "Самаранефтегеофизика"',
    },
    {
        id: 16,
        author: "Халитов Ф.Г.",
        ...
        img: "../images/feedback/16.png",
        alt: "Отзыв от Управления дорожного хозяйства РБ",
    },
    {
        id: 17,
        author: "Агеев Д.В.",
        ...
        img: "../images/feedback/17.png",
        alt: 'Отзыв от компании "Кольская верфь"',
    },
    {
        id: 18,
        ...
        img: "../images/feedback/18.png",
        alt: "Отзыв от Русского географического общества",
    },
    {
        id: 19,
        author: "Пелевин М.Л.",
        ...
        img: "../images/feedback/19.png",
        alt: 'Отзыв от компании "Башнефть-Добыча"',
    },
    {
        id: 1,
        ...
        img: "../images/feedback/1.png",
        alt: 'Отзыв от ГУП "Аскинский лес"',
    },
    {
        id: 2,
        ...
        img: "../images/feedback/2.png",
        alt: 'Отзыв от туристического агентства "Зианчура"',
    },
    {
        id: 3,
        author: "Султанов Р.Ф.",
        ...
        img: "../images/feedback/3.png",
        alt: 'Отзыв от компании "ГазСтройИнвест"',
    },
    {
        id: 4,
        ...
        img: "../images/feedback/4.png",
        alt: 'Отзыв от компании "ПРОМСНАБ"',
    },
    {
        id: 5,
        author: "Титов А.В.",
        ...
        img: "../images/feedback/5.png",
        alt: 'Отзыв от компании "ИнГео"',
    },
    {
        id: 6,
        author: "Евдокимов А.Н.",
        ...
        img: "../images/feedback/6.png",
        alt: 'Отзыв от ИП "Евдокимов А.Н."',
    },
    {
        id: 7,
        ...
        img: "../images/feedback/7.png",
        alt: 'Отзыв от ИП "Карамов А.М."',
    },
    {
        id: 8,
        author: "Бородина Л.Ф.",
        ...
        img: "../images/feedback/8.png",
        alt: 'Отзыв от компании "Карьер"',
    },
    {
        id: 9,
        ...
        img: "../images/feedback/9.png",
        alt: 'Отзыв от компании "Уфимское карьероуправление"',
    },
];
