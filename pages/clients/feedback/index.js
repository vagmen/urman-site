...
const initialData = [
    ...
    },
    {
        ...
        header:
            '"ООО "Гринландия" зарекомендовало себя как надежный добросовестный партнер, грамотно и своевременно исполняющий принятые на себя договорные обязательства"',
    ...
    },
    {
        ...
        header:
            '"При решении нестандартных задач, возникающих замечаний и предложений сотрудники моментально принимали эффективные действия по их решению"',
