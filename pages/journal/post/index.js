    ...
    return {
        postData: {
            ...
            post: [
                ...
                {
                    tag: "p",
                    content: "Хорошая в том, что мы готовы для Вас сделать новый Проект освоения лесов."
                },
                {
                    tag: "p",
                    content:
                ...
                },
                {
                    tag: "p",
                    content:
                        "Но есть в этом положительный момент. Напомним, что вносить изменения в Проект освоения лесов можно только в 3 случаях:"
                },
                {
                    tag: "li",
