...
class StartProjectForm extends Component {
    ...
    sendFeedbackInfo = async (values) => {
        const res = await fetch(
            `http://vagmen.ru/urman/send.php?name=${values.name}&email=${values.phone}&comment=${
                values.information
    ...
    render() {
        ...
        return (
            <div className="start-project-section">
                ...
                <p>
                    Мы бесплатно проконсультируем Вас по любому вопросу, связанному с оформлением и использованием
                    лесного участка
                </p>
